...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_vp_5fcamera_2eproto = {
  false, false, 1053, descriptor_table_protodef_vp_5fcamera_2eproto, "vp_camera.proto", 
...
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_vp_5fcamera_2eproto_getter() {
  return &descriptor_table_vp_5fcamera_2eproto;
}
...
void Camera_t::clear_stextrinsic() {
  if (GetArenaForAllocation() == nullptr && stextrinsic_ != nullptr) {
    delete stextrinsic_;
  }
  stextrinsic_ = nullptr;
}
...
inline void Camera_t::SharedCtor() {
imgdata_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
...
inline void Camera_t::SharedDtor() {
...
::PROTOBUF_NAMESPACE_ID::uint8* Camera_t::_InternalSerialize(
  ...
  // .vpdata.camera.Camera_t.CameraType eCameraType = 2;
  if (this->_internal_ecameratype() != 0) {
    target = stream->EnsureSpace(target);
  ...
  // bytes imgData = 7;
  if (!this->_internal_imgdata().empty()) {
    target = stream->WriteBytesMaybeAliased(
        7, this->_internal_imgdata(), target);
  }

  // .VgeoDB.common.Extrinsic_t stExtrinsic = 11;
  if (this->_internal_has_stextrinsic()) {
    target = stream->EnsureSpace(target);
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData Camera_t::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSizeCheck,
    Camera_t::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*Camera_t::GetClassData() const { return &_class_data_; }

void Camera_t::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message*to,
                      const ::PROTOBUF_NAMESPACE_ID::Message&from) {
  static_cast<Camera_t *>(to)->MergeFrom(
      static_cast<const Camera_t &>(from));
}
...
void Camera_t::InternalSwap(Camera_t* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      ...
      &imgdata_, GetArenaForAllocation(),
      &other->imgdata_, other->GetArenaForAllocation()
  );
...
::PROTOBUF_NAMESPACE_ID::Metadata Camera_t::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_vp_5fcamera_2eproto_getter, &descriptor_table_vp_5fcamera_2eproto_once,
      file_level_metadata_vp_5fcamera_2eproto[0]);
}
