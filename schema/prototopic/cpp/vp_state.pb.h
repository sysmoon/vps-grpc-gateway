...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_vp_5fstate_2eproto_metadata_getter(int index);
namespace vpdata {
namespace state {
class VPState_t;
...
class VPState_t PROTOBUF_FINAL :
 ...
 public:
  ...
  inline VPState_t* New() const final {
    return CreateMaybeMessage<VPState_t>(nullptr);
  }
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_vp_5fstate_2eproto_metadata_getter(kIndexInFileMessages);
  }
 ...
 private:
  ...
  mutable std::atomic<int> _arf64lastlocation_cached_byte_size_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedField< float > arf32lastorientation_;
  mutable std::atomic<int> _arf32lastorientation_cached_byte_size_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedField< float > arf32lastdrpose_;
  mutable std::atomic<int> _arf32lastdrpose_cached_byte_size_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedField< float > arf32curdrpose_;
  mutable std::atomic<int> _arf32curdrpose_cached_byte_size_;
...
inline ::vp::tracking::FramePoseInfo_t* VPState_t::add_stframeposeinfoset() {
  ...
  return _internal_add_stframeposeinfoset();
}
...
inline void VPState_t::set_allocated_stlinearvelocitykf(::vp::tracking::KalmanFilter_t* stlinearvelocitykf) {
  ...
  if (stlinearvelocitykf) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(stlinearvelocitykf)->GetArena();
...
inline void VPState_t::set_allocated_stvpsposekf(::vp::tracking::KalmanFilter_t* stvpsposekf) {
  ...
  if (stvpsposekf) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(stvpsposekf)->GetArena();
    if (message_arena != submessage_arena) {
...
inline ::vp::tracking::Param_t* VPState_t::add_stparamset() {
  ...
  return _internal_add_stparamset();
}
