...
class PoseInfo_t final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::vp::tracking::Pose_t* release_stpose();
...
class FramePoseInfo_t final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::vp::tracking::PoseInfo_t* release_stvpsposeinfo();
...
class Param_t final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_strname();
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_strval();
...
class MetaTrackingMode_t final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::vp::tracking::Pose_t* release_stcorrectingtr();
...
inline ::vp::tracking::Pose_t* PoseInfo_t::_internal_mutable_stpose() {
  ...
  if (stpose_ == nullptr) {
    auto* p = CreateMaybeMessage<::vp::tracking::Pose_t>(GetArenaForAllocation());
    stpose_ = p;
  }
  return stpose_;
}
inline ::vp::tracking::Pose_t* PoseInfo_t::mutable_stpose() {
  ::vp::tracking::Pose_t* _msg = _internal_mutable_stpose();
...
inline void PoseInfo_t::set_allocated_stpose(::vp::tracking::Pose_t* stpose) {
  ...
  if (stpose) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::vp::tracking::Pose_t>::GetOwningArena(stpose);
...
inline ::vp::tracking::PoseInfo_t* FramePoseInfo_t::_internal_mutable_stvpsposeinfo() {
  ...
  if (stvpsposeinfo_ == nullptr) {
    auto* p = CreateMaybeMessage<::vp::tracking::PoseInfo_t>(GetArenaForAllocation());
    stvpsposeinfo_ = p;
  }
  return stvpsposeinfo_;
}
inline ::vp::tracking::PoseInfo_t* FramePoseInfo_t::mutable_stvpsposeinfo() {
  ::vp::tracking::PoseInfo_t* _msg = _internal_mutable_stvpsposeinfo();
...
inline void FramePoseInfo_t::set_allocated_stvpsposeinfo(::vp::tracking::PoseInfo_t* stvpsposeinfo) {
  ...
  if (stvpsposeinfo) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::vp::tracking::PoseInfo_t>::GetOwningArena(stvpsposeinfo);
    if (message_arena != submessage_arena) {
...
inline ::vp::tracking::PoseInfo_t* FramePoseInfo_t::add_stlastdrposeinfoarray() {
  ::vp::tracking::PoseInfo_t* _add = _internal_add_stlastdrposeinfoarray();
...
inline ::vp::tracking::PoseInfo_t* FramePoseInfo_t::add_stlastegposeinfoarray() {
  ::vp::tracking::PoseInfo_t* _add = _internal_add_stlastegposeinfoarray();
...
void Param_t::set_strname(ArgT0&& arg0, ArgT... args) {
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void Param_t::set_strval(ArgT0&& arg0, ArgT... args) {
...
inline ::vp::tracking::Pose_t* MetaTrackingMode_t::mutable_stcorrectingtr() {
  ::vp::tracking::Pose_t* _msg = _internal_mutable_stcorrectingtr();
...
inline void MetaTrackingMode_t::set_allocated_stcorrectingtr(::vp::tracking::Pose_t* stcorrectingtr) {
  ...
  if (stcorrectingtr) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::vp::tracking::Pose_t>::GetOwningArena(stcorrectingtr);
    if (message_arena != submessage_arena) {
...
inline void MetaTrackingMode_t::set_allocated_stlinearvelocitykf(::vp::tracking::KalmanFilter_t* stlinearvelocitykf) {
  ...
  if (stlinearvelocitykf) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::vp::tracking::KalmanFilter_t>::GetOwningArena(stlinearvelocitykf);
    if (message_arena != submessage_arena) {
...
inline void MetaTrackingMode_t::set_allocated_stvpsposekf(::vp::tracking::KalmanFilter_t* stvpsposekf) {
  ...
  if (stvpsposekf) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::vp::tracking::KalmanFilter_t>::GetOwningArena(stvpsposekf);
    if (message_arena != submessage_arena) {
