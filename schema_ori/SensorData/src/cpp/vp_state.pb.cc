...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_vp_5fstate_2eproto = {
  false, false, 695, descriptor_table_protodef_vp_5fstate_2eproto, "vp_state.proto", 
...
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_vp_5fstate_2eproto_getter() {
  return &descriptor_table_vp_5fstate_2eproto;
}
...
inline void VPState_t::SharedCtor() {
...
inline void VPState_t::SharedDtor() {
...
::PROTOBUF_NAMESPACE_ID::uint8* VPState_t::_InternalSerialize(
  ...
  // uint64 u64TSLastLoc = 2;
  if (this->_internal_u64tslastloc() != 0) {
    target = stream->EnsureSpace(target);
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData VPState_t::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSizeCheck,
    VPState_t::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*VPState_t::GetClassData() const { return &_class_data_; }

void VPState_t::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message*to,
                      const ::PROTOBUF_NAMESPACE_ID::Message&from) {
  static_cast<VPState_t *>(to)->MergeFrom(
      static_cast<const VPState_t &>(from));
}
...
// @@protoc_insertion_point(class_specific_merge_from_start:vpdata.state.VPState_t)
  ...
  if (from._internal_u64tslastloc() != 0) {
    _internal_set_u64tslastloc(from._internal_u64tslastloc());
  }
  if (from._internal_evpstatus() != 0) {
...
::PROTOBUF_NAMESPACE_ID::Metadata VPState_t::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_vp_5fstate_2eproto_getter, &descriptor_table_vp_5fstate_2eproto_once,
      file_level_metadata_vp_5fstate_2eproto[0]);
}
