...
#ifndef GOOGLE_PROTOBUF_INCLUDED_lfsppdb_5fquery_5fkeyframeindex_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_lfsppdb_5fquery_5fkeyframeindex_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_lfsppdb_5fquery_5fkeyframeindex_2eproto
...
struct TableStruct_lfsppdb_5fquery_5fkeyframeindex_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_lfsppdb_5fquery_5fkeyframeindex_2eproto;
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_lfsppdb_5fquery_5fkeyframeindex_2eproto_metadata_getter(int index);
namespace lfsppdb {
...
PROTOBUF_NAMESPACE_OPEN
template<> ::lfsppdb::keyframeindex::KeyFrameIndexQ* Arena::CreateMaybeMessage<::lfsppdb::keyframeindex::KeyFrameIndexQ>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace lfsppdb {
namespace keyframeindex {
...
class KeyFrameIndexQ PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:lfsppdb.keyframeindex.KeyFrameIndexQ) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "lfsppdb.keyframeindex.KeyFrameIndexQ";
  }
  protected:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_lfsppdb_5fquery_5fkeyframeindex_2eproto_metadata_getter(kIndexInFileMessages);
  }
 ...
 private:
  ...
  friend struct ::TableStruct_lfsppdb_5fquery_5fkeyframeindex_2eproto;
};
// ===================================================================
...
inline ::PROTOBUF_NAMESPACE_ID::uint64 KeyFrameIndexQ::u64keyframeindex(int index) const {
  // @@protoc_insertion_point(field_get:lfsppdb.keyframeindex.KeyFrameIndexQ.u64KeyFrameIndex)
...
inline void KeyFrameIndexQ::set_u64keyframeindex(int index, ::PROTOBUF_NAMESPACE_ID::uint64 value) {
  ...
  // @@protoc_insertion_point(field_set:lfsppdb.keyframeindex.KeyFrameIndexQ.u64KeyFrameIndex)
}
...
inline void KeyFrameIndexQ::add_u64keyframeindex(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  ...
  // @@protoc_insertion_point(field_add:lfsppdb.keyframeindex.KeyFrameIndexQ.u64KeyFrameIndex)
}
...
KeyFrameIndexQ::u64keyframeindex() const {
  // @@protoc_insertion_point(field_list:lfsppdb.keyframeindex.KeyFrameIndexQ.u64KeyFrameIndex)
...
KeyFrameIndexQ::mutable_u64keyframeindex() {
  // @@protoc_insertion_point(field_mutable_list:lfsppdb.keyframeindex.KeyFrameIndexQ.u64KeyFrameIndex)
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_lfsppdb_5fquery_5fkeyframeindex_2eproto
