...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_vgeodb_5fcommon_2eproto = {
  false, false, 563, descriptor_table_protodef_vgeodb_5fcommon_2eproto, "vgeodb_common.proto", 
...
descriptor_table_vgeodb_5fcommon_2eproto_metadata_getter(int index) {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_vgeodb_5fcommon_2eproto);
  return descriptor_table_vgeodb_5fcommon_2eproto.file_level_metadata[index];
}
...
// @@protoc_insertion_point(generalized_merge_from_start:VgeoDB.common.XYZ64_t)
  GOOGLE_DCHECK_NE(&from, this);
  const XYZ64_t* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<XYZ64_t>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:VgeoDB.common.XYZ64_t)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:VgeoDB.common.XYZ64_t)
    MergeFrom(*source);
  }
}
...
// @@protoc_insertion_point(generalized_copy_from_start:VgeoDB.common.XYZ64_t)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(generalized_merge_from_start:VgeoDB.common.XYZ32_t)
  GOOGLE_DCHECK_NE(&from, this);
  const XYZ32_t* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<XYZ32_t>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:VgeoDB.common.XYZ32_t)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:VgeoDB.common.XYZ32_t)
    MergeFrom(*source);
  }
}
...
// @@protoc_insertion_point(generalized_copy_from_start:VgeoDB.common.XYZ32_t)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(generalized_merge_from_start:VgeoDB.common.Orientation32_t)
  GOOGLE_DCHECK_NE(&from, this);
  const Orientation32_t* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<Orientation32_t>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:VgeoDB.common.Orientation32_t)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:VgeoDB.common.Orientation32_t)
    MergeFrom(*source);
  }
}
...
// @@protoc_insertion_point(message_clear_start:VgeoDB.common.Extrinsic_t)
  ...
  if (GetArena() == nullptr && sttranslate_ != nullptr) {
    delete sttranslate_;
  }
  sttranslate_ = nullptr;
...
void Extrinsic_t::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:VgeoDB.common.Extrinsic_t)
  GOOGLE_DCHECK_NE(&from, this);
  const Extrinsic_t* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<Extrinsic_t>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:VgeoDB.common.Extrinsic_t)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:VgeoDB.common.Extrinsic_t)
    MergeFrom(*source);
  }
}
...
void Extrinsic_t::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:VgeoDB.common.Extrinsic_t)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void Point2DInt_t::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:VgeoDB.common.Point2DInt_t)
  GOOGLE_DCHECK_NE(&from, this);
  const Point2DInt_t* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<Point2DInt_t>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:VgeoDB.common.Point2DInt_t)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:VgeoDB.common.Point2DInt_t)
    MergeFrom(*source);
  }
}
...
void Point2DInt_t::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:VgeoDB.common.Point2DInt_t)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void Point2DFloat_t::SharedCtor() {
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
...
void Point2DFloat_t::SharedDtor() {
  GOOGLE_DCHECK(GetArena() == nullptr);
}
...
void Point2DFloat_t::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:VgeoDB.common.Point2DFloat_t)
  GOOGLE_DCHECK_NE(&from, this);
  const Point2DFloat_t* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<Point2DFloat_t>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:VgeoDB.common.Point2DFloat_t)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:VgeoDB.common.Point2DFloat_t)
    MergeFrom(*source);
  }
}
...
// @@protoc_insertion_point(class_specific_merge_from_start:VgeoDB.common.Point2DFloat_t)
  ...
  if (!(from.fu() <= 0 && from.fu() >= 0)) {
    _internal_set_fu(from._internal_fu());
  }
  if (!(from.fv() <= 0 && from.fv() >= 0)) {
    _internal_set_fv(from._internal_fv());
  }
}

void Point2DFloat_t::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:VgeoDB.common.Point2DFloat_t)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void UVPoint_t::set_allocated_stpointint(::VgeoDB::common::Point2DInt_t* stpointint) {
  ...
  if (stpointint) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::GetArena(stpointint);
...
void UVPoint_t::set_allocated_stpointfloat(::VgeoDB::common::Point2DFloat_t* stpointfloat) {
  ...
  if (stpointfloat) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::GetArena(stpointfloat);
    if (message_arena != submessage_arena) {
...
// @@protoc_insertion_point(generalized_merge_from_start:VgeoDB.common.UVPoint_t)
  GOOGLE_DCHECK_NE(&from, this);
  const UVPoint_t* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<UVPoint_t>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:VgeoDB.common.UVPoint_t)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:VgeoDB.common.UVPoint_t)
    MergeFrom(*source);
  }
}
...
// @@protoc_insertion_point(generalized_copy_from_start:VgeoDB.common.UVPoint_t)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
