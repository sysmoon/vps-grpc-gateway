...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_vp_5fcamera_2eproto_metadata_getter(int index);
namespace vpdata {
namespace camera {
class Camera_t;
...
class Camera_t PROTOBUF_FINAL :
 ...
 public:
  ...
  inline Camera_t* New() const final {
    return CreateMaybeMessage<Camera_t>(nullptr);
  }
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_vp_5fcamera_2eproto_metadata_getter(kIndexInFileMessages);
  }
  ...
  ::VgeoDB::common::Extrinsic_t* release_stextrinsic();
...
inline void Camera_t::set_imgdata(const std::string& value) {
  _internal_set_imgdata(value);
...
inline void Camera_t::set_imgdata(std::string&& value) {
  
  imgdata_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:vpdata.camera.Camera_t.imgData)
}
inline void Camera_t::set_imgdata(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  imgdata_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:vpdata.camera.Camera_t.imgData)
}
inline void Camera_t::set_imgdata(const void* value,
    size_t size) {
  
  imgdata_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:vpdata.camera.Camera_t.imgData)
}
...
inline ::VgeoDB::common::Extrinsic_t* Camera_t::_internal_mutable_stextrinsic() {
  ...
  if (stextrinsic_ == nullptr) {
    auto* p = CreateMaybeMessage<::VgeoDB::common::Extrinsic_t>(GetArena());
    stextrinsic_ = p;
  }
  return stextrinsic_;
}
inline ::VgeoDB::common::Extrinsic_t* Camera_t::mutable_stextrinsic() {
  ...
  return _internal_mutable_stextrinsic();
}
inline void Camera_t::set_allocated_stextrinsic(::VgeoDB::common::Extrinsic_t* stextrinsic) {
  ...
  if (stextrinsic) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(stextrinsic)->GetArena();
